            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Button
                  onClick={() =>
                    router.push(
                      `/teacher/courses/${course.id}/discussions/create`
                    )
                  }
                >
                  <Plus className="h-4 w-4 mr-2" />
                    ...
                    {course.discussions.map((discussion) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={() =>
                            router.push(
                              `/teacher/courses/${course.id}/discussions/${discussion.id}`
                            )
                          }
                        >
                          View
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Button
                  onClick={() =>
                    router.push(
                      `/teacher/courses/${course.id}/assignments/create`
                    )
                  }
                >
                  <Plus className="h-4 w-4 mr-2" />
                    ...
                    {course.assignments.map((assignment) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={() =>
                            router.push(
                              `/teacher/courses/${course.id}/assignments/${assignment.id}`
                            )
                          }
                        >
                          View
          ...
          <TabsContent value="exams" className="mt-6">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Button
                  onClick={() =>
                    router.push(`/teacher/courses/${course.id}/exams/create`)
                  }
                >
                  <Plus className="h-4 w-4 mr-2" />
                  Add Exam
                    ...
                    {course.exams.map((exam) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={() =>
                            router.push(
                              `/teacher/courses/${course.id}/exams/${exam.id}`
                            )
                          }
                        >
                          View
